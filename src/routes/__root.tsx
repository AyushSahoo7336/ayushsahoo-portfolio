...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Personal portfolio of a software developer building web, mobile, and games." },
      { property: "og:title", content: "Portfolio — Software Developer" },
      { property: "og:description", content: "Personal portfolio of a software developer building web, mobile, and games." },
