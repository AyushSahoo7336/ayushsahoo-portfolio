...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Personal portfolio of Ayush Sahoo — Software Developer building real-time systems, web apps, and distributed architecture." },
      { property: "og:title", content: "Ayush Sahoo - Portfolio" },
      { property: "og:description", content: "Personal portfolio of Ayush Sahoo — Software Developer building real-time systems, web apps, and distributed architecture." },
