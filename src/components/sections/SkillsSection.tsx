...
export function SkillsSection() {
  ...
  return (
    <div className="pb-20">
      ...
      />
      <section className="mx-auto grid max-w-6xl grid-cols-1 gap-5 px-4 sm:px-6 sm:grid-cols-2 md:grid-cols-3">
      ...
      <Dialog open={openId !== null} onOpenChange={(o) => !o && setOpenId(null)}>
        <DialogContent
          className="max-h-[85vh] overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden border bg-[var(--glass-bg)] backdrop-blur-xl shadow-[0_0_40px_color-mix(in_oklab,var(--primary-accent)_10%,transparent)] md:max-w-2xl lg:max-w-4xl"
