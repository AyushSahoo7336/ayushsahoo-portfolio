        ...
        {skills.map((s, i) => {
          ...
          return (
            <motion.button
              ...
              className="group block h-full rounded-2xl border border-white/10 bg-white/[0.02] p-6 text-left backdrop-blur-sm transition hover:-translate-y-1 hover:border-white/20"
            >
              <span
